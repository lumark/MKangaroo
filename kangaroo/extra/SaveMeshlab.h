...
inline void SaveMeshlab(roo::BoundedVolume<roo::SDF_t, roo::TargetDevice, roo::Manage>& vol, std::vector<std::unique_ptr<KinectKeyframe> >& keyframes, float fu, float fv, float u0, float v0)
{
