...
template<typename T>
void SavePXM(const std::string filename, const roo::Image<T,roo::TargetHost>& image,
...
template<typename T>
void SavePXM(const std::string filename, const roo::Image<T,roo::TargetDevice>& image,
             std::string ppm_type = "P5", int num_colors = 255)
{
...
template<typename T, typename Manage>
void SavePXM(const std::string filename, const roo::Volume<T,roo::TargetHost,Manage>& vol,
             std::string ppm_type = "P5", int num_colors = 255)
{
  std::ofstream bFile( filename.c_str(), std::ios::out | std::ios::binary );
...
template<typename T, typename Manage>
void SavePXM(std::ofstream& bFile, const roo::Volume<T,roo::TargetDevice,Manage>& vol,
             std::string ppm_type = "P5", int num_colors = 255)
{
...
template<typename T, typename Manage>
void SavePXM(const std::string filename, const roo::BoundedVolume<T,roo::TargetDevice,Manage>& vol,
             std::string ppm_type = "P5", int num_colors = 255)
{
  std::ofstream bFile( filename.c_str(), std::ios::out | std::ios::binary );
...
template<typename T, typename Manage>
void SavePXM(const std::string filename, const roo::Volume<T,roo::TargetDevice,Manage>& vol,
             std::string ppm_type = "P5", int num_colors = 255)
{
  std::ofstream bFile( filename.c_str(), std::ios::out | std::ios::binary );
  SavePXM<T,Manage>(bFile,vol,ppm_type,num_colors);
